...
from app.models.user_exceptions import FilmNotFound, InvalidDataError
...
class UserController:
    ...
    def create(cls):
        try:
            ...
            return render_template("result_pages/welcome.html", user=user), 201
    ...
    def delete(cls, user_id):
        ...
        if User.exists(user_id):
            ...
            raise FilmNotFound(user_id).get_response()